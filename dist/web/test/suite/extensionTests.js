...
var require_mocha = __commonJS({
  "node_modules/mocha/mocha.js"(exports, module2) {
    ...
    (function(global2, factory) {
      ...
      Buffer$1.prototype.write = function write3(string2, offset, length, encoding) {
        if (offset === void 0) {
          encoding = "utf8";
          length = this.length;
          offset = 0;
      ...
      (function(exports2) {
        ...
        Diff.prototype = {
          ...
          /*istanbul ignore start*/
          /*istanbul ignore end*/
          equals: function equals2(left, right, options) {
      ...
      function byteLength2(string2, encoding) {
        ...
        for (; ; ) {
          switch (encoding) {
            ...
            default:
              if (loweredCase) return utf8ToBytes2(string2).length;
              encoding = ("" + encoding).toLowerCase();
              loweredCase = true;
          }
        }
      ...
      (function(module3, exports2) {
        ...
        Suite2.prototype.timeout = function(ms2) {
          ...
          for (const s2 of this.suites) {
            s2.timeout(this._timeout);
          }
          return this;
        };
...
`;
      ...
      (function(module3, exports2) {
        ...
        TAPProducer.prototype.writeFail = function(n, test3) {
...
`
            ...
            if (!reporter2) {
              ...
              try {
                ...
                try {
                  ...
                  throw createInvalidReporterError2(err2.message, reporterName);
                }
              }
            }
      ...
      process2.listeners = function(err) {
